...
<body id="page-top" onload="varify()">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Disaster Management List</li>
        </ol>
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            Available Dsaster Management/div>
          ...
          <div class="lg-card-container" id="card-cap">
                ...
                <div class="card" id="ml">
                    <div class="preview">
                        <h6>Simulator</h6>
                        <h2>Sub Title</h2>
                        <a href="dm_systems_ml.php">Click</a>
                    ...
                    <div class="content">
                        ...
                        <a class="btn-card-lg" href="dm_systems_ml.php">Click Here</a>
                ...
                <div class="card">
                  ...
                  <div class="content">
                      ...
                      <a class="btn-card-lg" href="dm_systems.php">Click Here</a>

                  </div>
              </div>

              <div class="card empty">
                  <a href="dm_form.html?user=<?php if(isset($_SESSION['Username'])) { echo $_SESSION['Username'];} else echo "NO USER"?>"><h2>Add New Disaster Management Project</h2></a> 
              </div>
        ...
        <script>
          ...
          function varify(){
            var ma_learn = document.getElementById('ml');
            if(!role.trim()=="Admin"){
              ma_learn.style.display = "none";
            }
          }
